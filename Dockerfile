...
# intall packages
RUN apt update; apt install -y git mariadb-server zip unzip openjdk-11-jdk maven golang nano iproute2 wget gzip php
...
RUN sed -i "s/'ENABLE_REDIS','true'/'ENABLE_REDIS','false'/" '/scripts/sql/3. Data.sql'
